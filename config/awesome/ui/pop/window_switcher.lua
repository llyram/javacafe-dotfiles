...
local window_switcher_hide = function(window_switcher_box)
      ...
      widget_template = {
        ...
        update_callback = function(self, c, _, _)
          if c == client.focus then
            self.shape_border_color = beautiful.xcolor8
            self.shape_border_width = beautiful.widget_border_width
          else
            self.shape_border_width = dpi(0)
          end
        end,
        create_callback = function(self, c, _, _)
          ...
          if c == client.focus then
            ...
            self.shape_border_width = dpi(0)
          end                        self:get_children_by_id("thumbnail")[1].image =
          gears.surface.load(
          img
          )
        end,
  ...
  local enable = function(opts)
    ...
    awesome.connect_signal("oof::window_switcher::turn_on", function()
